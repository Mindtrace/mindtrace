...
| `mindtrace/models/mindtrace/models/archivers/__init__.py` | 6 | 15-16, 21-22, 27-28 | **B** | SDK/filesystem; mock I/O. |
| `mindtrace/models/mindtrace/models/archivers/huggingface/hf_model_archiver.py` | 6 | 61, 161, 200-201, 239-240 | **B** | SDK/filesystem; mock I/O. |
| `mindtrace/models/mindtrace/models/archivers/huggingface/hf_processor_archiver.py` | 2 | 67, 85 | **B** | SDK/filesystem; mock I/O. |
...
| `mindtrace/models/mindtrace/models/serving/service.py` | 4 | 150-151, 161-162 | **B** | Case-by-case: prefer pure-function extraction where possible. |
...
### Tier A (0 files, sorted by missing count)


### Tier B (98 files, sorted by missing count)
...
- `mindtrace/models/mindtrace/models/archivers/__init__.py` — **6** missing statements
- `mindtrace/models/mindtrace/models/archivers/huggingface/hf_model_archiver.py` — **6** missing statements
...
- `mindtrace/models/mindtrace/models/serving/service.py` — **4** missing statements
...
- `mindtrace/models/mindtrace/models/archivers/huggingface/hf_processor_archiver.py` — **2** missing statements
