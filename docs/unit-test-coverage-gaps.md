...
| `mindtrace/core/mindtrace/core/config/config.py` | 5 | 539, 802-803, 810-811 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/types/bounding_box.py` | 13 | 74, 108, 135-136, 139, 141-144, 151, 153-155 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/types/crop.py` | 3 | 40, 69, 128 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/utils/cropping.py` | 6 | 58, 155, 190, 192, 195, 197 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/utils/download.py` | 16 | 18-19, 21-24, 31-37, 39, 41, 137 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/utils/image_io.py` | 3 | 70, 72, 156 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/utils/letterbox.py` | 2 | 68, 70 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/utils/masks.py` | 6 | 89, 91, 152, 199, 253, 255 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
| `mindtrace/core/mindtrace/core/utils/network.py` | 7 | 120-125, 127 | **A** | mindtrace-core: types, utils, config branches—fast, high ROI. |
...
| `mindtrace/hardware/mindtrace/hardware/core/utils.py` | 1 | 49 | **B** | Hardware (non-core-package): backends and managers; mocks/fakes. |
...
| `mindtrace/hardware/mindtrace/hardware/services/cameras/models/requests.py` | 45 | 71, 73-82, 84, 184, 186-191, 193, 205, 236, 238-243, 245, 257, 439, 442, 476, 479, 481, 489, 492, 495, 502, 536-538, 577, 580, 587 | **A** | Pydantic models; validation and defaults. |
...
| `mindtrace/hardware/mindtrace/hardware/services/plcs/models/requests.py` | 28 | 70-74, 91-99, 101-102, 116-121, 137-142 | **A** | Pydantic models; validation and defaults. |
...
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/__init__.py` | 4 | 3-4, 7, 9 | **B** | Services: FastAPI/Discord/etc.; TestClient + mocks. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/connection_manager.py` | 91 | 8-9, 11, 13, 27, 30, 38, 40-44, 46, 48-52, 55, 57-58, 60, 62-63, 65, 67-69, 72, 74-76, 78, 80-82, 84, 86-88, 90, 92-94, 96, 98-99, 101, 103-104, 107, 109-111, 113, 115-117, 120, 122-124, 126, 128-130, 132, 134-136, 139, 153, 165-166, 168, 170-172, 175, 185, 193-194, 196, 200-202, 205, 207-208, 210, 212 | **B** | HTTP polling/client code; mock transport. |
...
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/models/__init__.py` | 3 | 3, 17, 51 | **B** | Services: FastAPI/Discord/etc.; TestClient + mocks. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/models/requests.py` | 70 | 8, 10, 14, 17, 21, 24-25, 28, 31-32, 35, 38, 41, 44, 48, 51, 55, 61, 64-67, 70-74, 77-78, 81-82, 85-86, 89-92, 95-97, 100, 103, 110, 113-125, 128, 131-132, 136, 139-144, 147, 150-151, 154 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/models/responses.py` | 155 | 8-9, 11, 13, 16, 19-21, 24, 27, 30, 33, 36, 39, 42, 45, 49, 52-56, 59, 62, 65, 68, 72, 75-77, 80, 83, 86, 89-93, 96, 99, 103, 107-110, 113-117, 120-121, 124-125, 128-129, 132-135, 138-140, 143, 146, 149, 153-157, 160-164, 167-170, 173-174, 177-179, 182, 185, 189, 192-204, 207, 210, 213, 216-219, 222, 225, 229, 232-240, 243, 246, 249, 252-255, 258, 261, 265, 268-271, 274, 277, 281, 284, 288, 291-295, 298, 301, 305, 308-314, 317 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/__init__.py` | 7 | 3, 9, 15, 18, 26, 36, 66 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/capture_schemas.py` | 7 | 3-4, 16, 18, 23, 27, 31 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/config_schemas.py` | 7 | 3-4, 15, 19, 23, 27, 31 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/health_schemas.py` | 4 | 3-4, 6, 8 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/info_schemas.py` | 9 | 3-4, 16, 18, 22, 27, 31, 35, 39 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/lifecycle_schemas.py` | 9 | 3-4, 15, 17, 22, 24, 28, 31, 35 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/service.py` | 343 | 8-10, 12-15, 17, 20-22, 25, 67-68, 71, 89, 95, 102, 105-107, 110, 119, 121, 125, 128, 131, 138, 141-142, 145-146, 149, 152, 161-163, 172, 178-179, 185, 193-194, 199, 202, 213, 215-217, 225-226, 237, 239-245, 247, 249-250, 252, 254, 257-259, 266-267, 275, 277, 279, 281-289, 291, 297, 299, 301-302, 304-309, 311, 313, 315-324, 326, 332, 334, 336-337, 339-344, 346, 348, 350-359, 361, 367, 369-370, 372-380, 382, 386, 388, 396, 398, 400-401, 403-404, 406, 408, 410, 412, 414-415, 417-419, 421, 423, 425, 427-428, 430, 438, 444, 446, 448-449, 451-453, 456, 478-480, 482, 484, 486-487, 489-490, 493, 504, 507-514, 517-526, 529-532, 535-538, 541-544, 547-554, 557-562, 564, 566-568, 570, 572, 574-577, 580-581, 583-587, 589, 595, 597, 599-600, 602-604, 607, 643-645, 651, 653, 655-656, 658-659, 661, 670, 673, 675-676, 678-679, 681-682, 684, 686-687, 689-690, 692, 708-710, 712, 714-717, 719-723, 725-726, 728, 730, 739, 741, 749-753, 755, 757, 765, 767, 769-770, 772-773, 775, 780, 783-784, 787-788, 790, 802-804, 806, 808-811, 813-817, 819-820, 822, 824, 829, 831, 838-842, 844, 846 | **B** | FastAPI: TestClient + dependency overrides. |
...
| `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/__init__.py` | 4 | 3-4, 7, 9 | **B** | Services: FastAPI/Discord/etc.; TestClient + mocks. |
| `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/connection_manager.py` | 89 | 8-9, 11, 13, 27, 30, 38, 40-44, 46, 48-52, 55, 57-58, 60, 62-63, 65, 67-69, 72, 74-76, 78, 80-82, 84, 86-88, 90, 92-94, 96, 98-99, 101, 103-104, 107, 109-111, 113, 115-117, 119, 121-122, 125, 127-129, 131, 133-135, 137, 139-141, 144, 156, 166-167, 169, 171-173, 175, 184, 191-192, 194, 198-200 | **B** | HTTP polling/client code; mock transport. |
...
| `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/models/__init__.py` | 4 | 3-4, 18, 49 | **B** | Services: FastAPI/Discord/etc.; TestClient + mocks. |
| `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/models/requests.py` | 43 | 8, 10, 14, 17, 21, 24-25, 28, 31-32, 35, 38, 41, 44, 48, 51, 55, 58-59, 62, 65, 72, 75-82, 85, 88-89, 93, 96-100, 103, 106-107, 110 | **A** | Pydantic models; validation and defaults. |
| `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras
| `mindtrace/models/mindtrace/models/__init__.py` | 8 | 92-93, 252-253, 255-258 | **A** | Package exports; compatibility smoke tests. |
...
| `mindtrace/models/mindtrace/models/evaluation/runner.py` | 1 | 110 | **B** | Case-by-case: prefer pure-function extraction where possible. |
| `mindtrace/models/mindtrace/models/pipeline.py` | 1 | 107 | **B** | Case-by-case: prefer pure-function extraction where possible. |
...
| `mindtrace/services/mindtrace/services/core/middleware.py` | 10 | 92-95, 111, 126-129, 146 | **B** | Services: FastAPI/Discord/etc.; TestClient + mocks. |
...
### Tier A (29 files, sorted by missing count)

- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/models/responses.py` — **155** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/models/responses.py` — **110** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/models/requests.py` — **70** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/cameras/models/requests.py` — **45** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/models/requests.py` — **43** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/plcs/models/requests.py` — **28** missing statements
- `mindtrace/core/mindtrace/core/utils/download.py` — **16** missing statements
- `mindtrace/core/mindtrace/core/types/bounding_box.py` — **13** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/info_schemas.py` — **9** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/lifecycle_schemas.py` — **9** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/schemas/info_schemas.py` — **9** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/schemas/lifecycle_schemas.py` — **9** missing statements
- `mindtrace/models/mindtrace/models/__init__.py` — **8** missing statements
- `mindtrace/core/mindtrace/core/utils/network.py` — **7** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/__init__.py` — **7** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/capture_schemas.py` — **7** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/config_schemas.py` — **7** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/schemas/__init__.py` — **7** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/schemas/capture_schemas.py` — **7** missing statements
- `mindtrace/core/mindtrace/core/utils/cropping.py` — **6** missing statements
- `mindtrace/core/mindtrace/core/utils/masks.py` — **6** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/schemas/config_schemas.py` — **6** missing statements
- `mindtrace/core/mindtrace/core/config/config.py` — **5** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/schemas/health_schemas.py` — **4** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/schemas/health_schemas.py` — **4** missing statements
- `mindtrace/core/mindtrace/core/types/crop.py` — **3** missing statements
- `mindtrace/core/mindtrace/core/utils/image_io.py` — **3** missing statements
- `mindtrace/core/mindtrace/core/utils/letterbox.py` — **2** missing statements
- `mindtrace/jobs/mindtrace/jobs/rabbitmq/client.py` — **2** missing statements

### Tier B (119 files, sorted by missing count)

- `mindtrace/hardware/mindtrace/hardware/cameras/backends/basler/basler_camera_backend.py` — **431** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/service.py` — **384** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/service.py` — **343** missing statements
...
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/connection_manager.py` — **91** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/connection_manager.py` — **89** missing statements
...
- `mindtrace/services/mindtrace/services/core/middleware.py` — **10** missing statements
...
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/__init__.py` — **4** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/__init__.py` — **4** missing statements
- `mindtrace/hardware/mindtrace/hardware/services/stereo_cameras/models/__init__.py` — **4** missing statements
...
- `mindtrace/hardware/mindtrace/hardware/services/scanners_3d/models/__init__.py` — **3** missing statements
...
- `mindtrace/hardware/mindtrace/hardware/core/utils.py` — **1** missing statements
- `mindtrace/models/mindtrace/models/evaluation/runner.py` — **1** missing statements
- `mindtrace/models/mindtrace/models/pipeline.py` — **1** missing statements
