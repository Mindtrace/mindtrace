...
def save_models(registry: Registry, model_id: int) -> None:
    ...
    model_data = {"weights": [0.1 * model_id, 0.2 * model_id], "metadata": {"accuracy": 0.8 + 0.01 * model_id}}
...
def load_and_evaluate(registry: Registry, model_id: int) -> Dict[str, Any]:
    ...
    return {"model_id": model_id, "accuracy": model_data["metadata"]["accuracy"], "weights": model_data["weights"]}
