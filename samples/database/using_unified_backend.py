...
async def demonstrate_unified_document_model():
    ...
    unified_user1 = UnifiedUserDoc(
        name="Unified User 1", age=28, email="unified1@example.com", skills=["Python", "MongoDB", "Redis"]
    )

    unified_user2 = UnifiedUserDoc(
        name="Unified User 2", age=32, email="unified2@example.com", skills=["JavaScript", "Docker", "Kubernetes"]
    )
