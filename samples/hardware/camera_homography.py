...
# Access the results
print(f"Object dimensions in different units:")
print(f"Millimeters - Width: {measured_object_mm.width_world:.2f} {measured_object_mm.unit}, Height: {measured_object_mm.height_world:.2f} {measured_object_mm.unit}")
print(f"Inches - Width: {measured_object_in.width_world:.3f} {measured_object_in.unit}, Height: {measured_object_in.height_world:.3f} {measured_object_in.unit}")
print(f"Feet - Width: {measured_object_ft.width_world:.4f} {measured_object_ft.unit}, Height: {measured_object_ft.height_world:.4f} {measured_object_ft.unit}")
