...
class TestRedisClient:
    ...
    def test_priority_queue(self):
        ...
        high_priority_job = create_test_job("high_priority")
        low_priority_job = create_test_job("low_priority")
        ...
        assert first_received.payload.name == "high_priority_schema"
        
        second_received = self.client.receive_message(queue_name)
        assert second_received.payload.name == "low_priority_schema"
