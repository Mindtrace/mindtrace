"""Registry tests for stereo camera service ``TaskSchema`` definitions."""
...
from mindtrace.hardware.services.stereo_cameras.schemas import __all__ as schemas_all
...
_SUBMODULES = (
    "mindtrace.hardware.services.stereo_cameras.schemas.capture_schemas",
    "mindtrace.hardware.services.stereo_cameras.schemas.config_schemas",
    "mindtrace.hardware.services.stereo_cameras.schemas.health_schemas",
    "mindtrace.hardware.services.stereo_cameras.schemas.info_schemas",
    "mindtrace.hardware.services.stereo_cameras.schemas.lifecycle_schemas",
)
...
def test_public_exports_are_task_schemas() -> None:
    ...
    mod = importlib.import_module("mindtrace.hardware.services.stereo_cameras.schemas")
    for n in names:
