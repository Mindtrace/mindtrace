...
class TestSensorManager:
    ...
    def test_register_sensor_success(self, mock_create_backend, mock_mqtt_backend, sample_mqtt_config):
        ...
        sensor = manager.register_sensor("test_sensor", "mqtt", sample_mqtt_config, "test/topic")
    ...
    async def test_read_all_success(
        self, mock_create_backend, mock_mqtt_backend, sample_mqtt_config, sample_sensor_data
    ):
