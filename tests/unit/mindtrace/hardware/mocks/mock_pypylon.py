...
def create_fake_pypylon():
    ...
    class DeviceInfo:
        ...
        def __init__(self, serial="12345678", model="acA1920-40uc", 
                     friendly_name=None, vendor="Basler", device_class="BaslerUsb"):
            self.serial = serial
            self.model = model
            self.vendor = vendor
    ...
    class GrabResult:
        ...
        def __init__(self, success=True, image_array=None, error_code=None, error_desc=None):
            ...
            self._image_array = image_array if image_array is not None else np.random.randint(0, 255, (1080, 1920, 3), dtype=np.uint8)
