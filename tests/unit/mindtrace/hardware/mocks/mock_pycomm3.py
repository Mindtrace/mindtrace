...
def create_fake_pycomm3():
    ...
    class LogixDriver(BasePLCDriver):
        ...
        def get_module_info(self, slot: int) -> Dict:
            ...
            modules = {
                0: {"vendor": "Allen Bradley", "product_type": "CPU", 
                    "product_name": "1756-L85E", "status": "Running"},
                1: {"vendor": "Allen Bradley", "product_type": "Digital Input",
                    "product_name": "1756-IB32", "status": "OK"},
                2: {"vendor": "Allen Bradley", "product_type": "Digital Output",
                    "product_name": "1756-OB32", "status": "OK"},
                3: {"vendor": "Allen Bradley", "product_type": "Analog Input",
                    "product_name": "1756-IF8", "status": "OK"},
            }
            return modules.get(slot, {"vendor": "Empty", "product_type": "Empty",
                                     "product_name": "Empty", "status": "Empty"})
    ...
    class GenericConnectedRequestPacket:
        """Mock request packet."""
        def __init__(self, service: bytes, class_code: bytes, instance: bytes, 
                     attribute: bytes = b'', data: bytes = b''):
    ...
    class GenericUnconnectedRequestPacket:
        ...
        def __init__(self, service: bytes, class_code: bytes, instance: bytes,
                     attribute: bytes = b'', data: bytes = b'', route_path: bytes = b''):
            self.service = service
            self.class_code = class_code
            self.instance = instance
            self.attribute = attribute
