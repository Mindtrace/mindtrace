...
class TestMeasuredBox:
    ...
    def test_measured_box_creation(self):
        ...
        measured_box = MeasuredBox(
            corners_world=corners, width_world=10.0, height_world=5.0, area_world=50.0, unit="mm"
        )
    ...
    def test_measured_box_different_units(self):
        ...
        for unit in ["mm", "cm", "m", "in", "ft"]:
            measured_box = MeasuredBox(
                corners_world=corners, width_world=1.0, height_world=1.0, area_world=1.0, unit=unit
            )
...
class TestHomographyMeasurer:
    ...
    def test_measure_bounding_boxes_with_unit_conversion(self):
        ...
        boxes = [BoundingBox(x=100, y=50, width=100, height=100), BoundingBox(x=200, y=100, width=200, height=100)]
