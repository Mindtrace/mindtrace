...
class TestHomographyIntegration:
    ...
    def test_workflow_with_camera_intrinsics(self):
        ...
        image_points = np.array([
            [150.0, 150.0], [250.0, 152.0], [248.0, 250.0], [152.0, 248.0]
        ], dtype=np.float64)
    ...
    def test_error_propagation(self):
        ...
        world_points = np.array([
            [0.0, 0.0], [1.0, 0.0], [2.0, 0.0], [3.0, 0.0]  # All on same line
        ], dtype=np.float64)
    ...
    def test_precision_and_accuracy(self):
        ...
        # Perfect 2x scaling
        image_points = np.array([
            [100.0, 200.0], [200.0, 200.0], [200.0, 260.0], [100.0, 260.0]
        ], dtype=np.float64)
    ...
    def test_workflow_robustness(self):
        ...
        image_points = np.array([
            [200.0, 200.0], [400.0, 200.0], [400.0, 400.0], [200.0, 400.0], [300.0, 300.0]
        ], dtype=np.float64)
