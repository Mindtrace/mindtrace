...
class TestProxyWorker:
    ...
    def test_proxy_worker_creation(self):
        ...
        worker = ProxyWorker(worker_type="test.worker.TestWorker", worker_params={"param1": "value1", "param2": 42})
    ...
    def test_proxy_worker_model_dump(self):
        ...
        worker = ProxyWorker(worker_type="test.worker.TestWorker", worker_params={"param1": "value1"})
...
class TestStandardWorkerLauncher:
    ...
    def sample_worker(self):
        ...
        return ProxyWorker(worker_type="test.worker.TestWorker", worker_params={"param1": "value1", "param2": 42})
    ...
    def test_load_worker(self, launcher, sample_worker):
        ...
        with patch("mindtrace.cluster.core.cluster.get_class", return_value=mock_worker_class):
            ...
            mock_worker_class.launch.assert_called_once_with(
                url="http://worker:8080", param1="value1", param2=42, wait_for_launch=True, timeout=60
            )
    ...
    def test_load_worker_with_git_environment(self, launcher, git_worker):
        ...
        with (
            ...
            mock_timeout_handler.run.assert_called_once_with(mock_worker_class.connect, url="http://git-worker:8080")
