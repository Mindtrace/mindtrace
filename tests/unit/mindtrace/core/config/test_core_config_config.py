...
class TestConfigDictAccess:
    ...
    def test_minio_endpoint_defaults_from_ini(self):
    ...
    def test_minio_endpoint_env_override(self):
        """MINDTRACE_MINIO__MINIO_ENDPOINT overrides config.ini."""
        with patch.dict(os.environ, {"MINDTRACE_MINIO__MINIO_ENDPOINT": "localhost:19000"}):
            settings = Config()
