...
def backend(tmp_path):
    """Create an isolated local backend for each test."""
    return LocalRegistryBackend(uri=str(tmp_path / "registry"))


def test_registry_multi_model_initialization(backend):
...
def test_registry_multi_model_attribute_access(backend):
...
def test_registry_multi_model_invalid_attribute(backend):
...
def test_registry_multi_model_cannot_use_direct_insert(backend):
...
def test_registry_multi_model_backward_compatibility(backend):
...
def test_registry_multi_model_shared_registry(backend):
...
def test_registry_multi_model_both_model_cls_and_models_error(backend):
...
def test_registry_multi_model_empty_models_error(backend):
...
def test_registry_multi_model_cannot_use_direct_get(backend):
...
def test_registry_multi_model_cannot_use_direct_update(backend):
...
def test_registry_multi_model_cannot_use_direct_delete(backend):
...
def test_registry_multi_model_cannot_use_direct_all(backend):
...
def test_registry_multi_model_cannot_use_direct_find(backend):
...
def test_registry_multi_model_cannot_use_direct_get_raw_model(backend):
