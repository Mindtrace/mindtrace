...
class DatalakeService(Service):
    ...
    @endpoint("assets.list_page", schema=ListAssetsPageSchema)
    ...
    @endpoint("collections.list_page", schema=ListCollectionsPageSchema)
    ...
    @endpoint("collection_items.list_page", schema=ListCollectionItemsPageSchema)
    ...
    @endpoint("asset_retentions.list_page", schema=ListAssetRetentionsPageSchema)
    ...
    @endpoint("annotation_schemas.list_page", schema=ListAnnotationSchemasPageSchema)
    ...
    @endpoint("annotation_sets.list_page", schema=ListAnnotationSetsPageSchema)
    ...
    @endpoint("annotation_records.list_for_asset_page", schema=ListAnnotationRecordsForAssetPageSchema)
    ...
    @endpoint("annotation_records.list_page", schema=ListAnnotationRecordsPageSchema)
    ...
    @endpoint("datums.list_page", schema=ListDatumsPageSchema)
    ...
    @endpoint("dataset_versions.list_page", schema=ListDatasetVersionsPageSchema, as_tool=True)
    ...
    @endpoint("dataset_versions.view_page", schema=ViewDatasetVersionPageSchema, as_tool=True)
