...
class Datum(MindtraceDocument):
    ...
    project_id: Annotated[str, Indexed(unique=False)] = Field(description="Name of the project this datum belongs to.")
    line_id: Annotated[str, Indexed(unique=False)] = Field(description="Name of the line this datum belongs to.")
