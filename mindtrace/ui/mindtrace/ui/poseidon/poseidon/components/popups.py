...
# Keep original demo popup for reference
def popups_v1():
    """Original Buridan UI demo popup - for reference."""
    demo_prompts = [
        ["Vivamus suscipit tortor eget", "Phasellus volutpat metus ac urna egestas."],
        ["Integer malesuada nunc vel", "Vestibulum ante ipsum primis in faucibus."],
        ["Nullam quis risus eget urna", "Donec ullamcorper nulla non metus auctor."],
    ]
            ...
            rx.dialog.content(
                ...
                rx.vstack(
                    *[
                        ...
                        for name, subtitle in demo_prompts
                    ],
                    height="45vh",
                    overflow="scroll",
                    mask="linear-gradient(to bottom, hsl(0, 0%, 0%, 1) 90%, hsl(0, 0%, 0%, 0) 100%)",
