...
Timed workloads use **`mindtrace.core.testing`**: **`BenchTestSuite`**, **`TestRunner`**, and **`mindtrace-bench`**. See **[benchmarks.md](benchmarks.md)** for registering suites, running shipped benches, and adding application-specific benchmarks.
