...
class CameraManagerService(Service):
    ...
    @endpoint("cameras/capture-groups/configure", schema=ALL_SCHEMAS["configure_capture_groups"], as_tool=True)
    ...
    @endpoint("cameras/capture-groups", schema=ALL_SCHEMAS["get_capture_groups"], methods=("GET",), as_tool=True)
    ...
    @endpoint("cameras/capture-groups/remove", schema=ALL_SCHEMAS["remove_capture_groups"], as_tool=True)
    ...
    @endpoint("cameras/lens/status", schema=ALL_SCHEMAS["get_lens_status"], as_tool=True)
    ...
    @endpoint("cameras/focus/optical-power/get", schema=ALL_SCHEMAS["get_optical_power"], as_tool=True)
    ...
    @endpoint("cameras/focus/optical-power/set", schema=ALL_SCHEMAS["set_optical_power"], as_tool=True)
    ...
    @endpoint("cameras/focus/autofocus", schema=ALL_SCHEMAS["trigger_autofocus"], as_tool=True)
    ...
    @endpoint("cameras/focus/config/get", schema=ALL_SCHEMAS["get_focus_config"], methods=("GET",), as_tool=True)
    ...
    @endpoint("cameras/focus/config/set", schema=ALL_SCHEMAS["set_focus_config"], as_tool=True)
