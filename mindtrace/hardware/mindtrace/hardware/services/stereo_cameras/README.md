...
uv run python -m mindtrace.hardware.services.stereo_cameras.launcher

# With custom host and port
uv run python -m mindtrace.hardware.services.stereo_cameras.launcher --host 0.0.0.0 --port 8004
```
...
- API models: `/mindtrace/hardware/services/stereo_cameras/models/`
- MCP schemas: `/mindtrace/hardware/services/stereo_cameras/schemas/`
