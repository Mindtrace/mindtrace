...
from .schemas import SensorLifecycleSchemas, SensorDataSchemas
...
class SensorManagerService(Service):
    ...
    def _register_endpoints(self) -> None:
        ...
        self.add_endpoint(
            path="/list_sensors",
            schema=SensorLifecycleSchemas.list_sensors,
            func=self.list_sensors,
            as_tool=True
        )
        ...
        try:
            ...
            if sensor:
                ...
                return SensorStatusResponse(
                    success=False,
                    sensor_info=None,
                    message=f"Sensor '{request.sensor_id}' not found"
                )
    ...
    async def list_sensors(self, request: SensorListRequest) -> SensorListResponse:
        ...
        try:
            ...
            return SensorListResponse(
                ...
                sensors=[],
                count=0,
                message=f"Failed to list sensors: {str(e)}"
            )
