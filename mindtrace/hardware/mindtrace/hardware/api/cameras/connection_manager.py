...
class CameraManagerConnectionManager(ConnectionManager):
    ...
    async def capture_image(self, camera: str, save_path: Optional[str] = None, upload_to_gcs: bool = False) -> Dict[str, Any]:
    ...
    async def capture_hdr_image(self, camera: str, save_path_pattern: Optional[str] = None, 
                               ...
                               return_images: bool = True, upload_to_gcs: bool = False) -> Dict[str, Any]:
