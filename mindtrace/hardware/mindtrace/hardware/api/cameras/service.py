...
class CameraManagerService(Service):
    ...
    def _register_endpoints(self):
        ...
        self.add_endpoint("system/diagnostics", self.get_system_diagnostics, ALL_SCHEMAS["get_system_diagnostics"], methods=["GET"])
        
        # Camera Configuration
        self.add_endpoint("cameras/configure", self.configure_camera, ALL_SCHEMAS["configure_camera"])
        self.add_endpoint("cameras/configure/batch", self.configure_cameras_batch, ALL_SCHEMAS["configure_cameras_batch"])
        self.add_endpoint("cameras/configuration", self.get_camera_configuration, ALL_SCHEMAS["get_camera_configuration"])
        ...
        self.add_endpoint("cameras/capture/hdr/batch", self.capture_hdr_images_batch, ALL_SCHEMAS["capture_hdr_images_batch"])
        
        # Network & Bandwidth
        self.add_endpoint("network/bandwidth", self.get_bandwidth_settings, ALL_SCHEMAS["get_bandwidth_settings"], methods=["GET"])
        self.add_endpoint("network/bandwidth/limit", self.set_bandwidth_limit, ALL_SCHEMAS["set_bandwidth_limit"])
        self.add_endpoint("network/diagnostics", self.get_network_diagnostics, ALL_SCHEMAS["get_network_diagnostics"], methods=["GET"])
    ...
    def _register_mcp_tools(self):
        ...
        self.add_endpoint("cameras/configuration", self.get_camera_configuration, ALL_SCHEMAS["get_camera_configuration"], as_tool=True)
        self.add_endpoint("cameras/status", self.get_camera_status, ALL_SCHEMAS["get_camera_status"], as_tool=True)
        
        # System operations
        self.add_endpoint("system/diagnostics", self.get_system_diagnostics, ALL_SCHEMAS["get_system_diagnostics"], methods=["GET"], as_tool=True)
    ...
    async def discover_backends(self) -> BackendsResponse:
        ...
        try:
            ...
            return BackendsResponse(
                success=True,
                message=f"Found {len(backends)} available backends",
                data=backends
            )
        except Exception as e:
    ...
    async def get_backend_info(self) -> BackendInfoResponse:
        ...
        try:
            ...
            return BackendInfoResponse(
                success=True,
                message=f"Retrieved information for {len(backend_models)} backends",
                data=backend_models
            )
        except Exception as e:
    ...
    async def open_camera(self, request: CameraOpenRequest) -> BoolResponse:
        ...
        try:
            ...
            return BoolResponse(
                success=True,
                message=f"Camera '{request.camera}' opened successfully",
                data=True
            )
        except Exception as e:
    ...
    async def close_camera(self, request: CameraCloseRequest) -> BoolResponse:
        ...
        try:
            ...
            return BoolResponse(
                success=True,
                message=f"Camera '{request.camera}' closed successfully",
                data=True
            )
        except Exception as e:
    ...
    async def close_all_cameras(self) -> BoolResponse:
        ...
        try:
            ...
            return BoolResponse(
                success=True,
                message=f"Successfully closed {camera_count} cameras",
                data=True
            )
        except Exception as e:
    ...
    async def get_active_cameras(self) -> ActiveCamerasResponse:
        ...
        try:
            ...
            return ActiveCamerasResponse(
                success=True,
                message=f"Found {len(active_cameras)} active cameras",
                data=active_cameras
            )
        except Exception as e:
    ...
    async def get_camera_status(self, request: CameraQueryRequest) -> CameraStatusResponse:
        ...
        try:
            ...
            return CameraStatusResponse(
                success=True,
                message=f"Retrieved status for camera '{request.camera}'",
                data=status
            )
        except Exception as e:
    ...
    async def get_camera_info(self, request: CameraQueryRequest) -> CameraInfoResponse:
        ...
        try:
            ...
            return CameraInfoResponse(
                success=True,
                message=f"Retrieved information for camera '{request.camera}'",
                data=info
            )
        except Exception as e:
    ...
    async def get_camera_capabilities(self, request: CameraQueryRequest) -> CameraCapabilitiesResponse:
        ...
        try:
            ...
            return CameraCapabilitiesResponse(
                success=True,
                message=f"Retrieved capabilities for camera '{request.camera}'",
                data=capabilities
            )
        except Exception as e:
    ...
    async def configure_camera(self, request: CameraConfigureRequest) -> BoolResponse:
        ...
        try:
            ...
            # Check if camera is active
            self.logger.debug(f"Checking if camera '{request.camera}' is in active cameras: {list(manager.active_cameras)}")
            if request.camera not in manager.active_cameras:
                raise CameraNotFoundError(f"Camera '{request.camera}' is not initialized")
            ...
            return BoolResponse(
                success=success,
                message=f"Camera '{request.camera}' configured successfully" if success else f"Configuration failed for '{request.camera}'",
                data=success
            )
        except Exception as e:
    ...
    async def get_camera_configuration(self, request: CameraQueryRequest) -> CameraConfigurationResponse:
        ...
        try:
            ...
            return CameraConfigurationResponse(
                success=True,
                message=f"Retrieved configuration for camera '{request.camera}'",
                data=config
            )
        except Exception as e:
    ...
    async def import_camera_config(self, request: ConfigFileImportRequest) -> ConfigFileResponse:
        ...
        try:
            ...
            return ConfigFileResponse(
                success=success,
                message=f"Configuration imported for camera '{request.camera}'" if success else f"Import failed for '{request.camera}'",
                data=result
            )
        except Exception as e:
    ...
    async def export_camera_config(self, request: ConfigFileExportRequest) -> ConfigFileResponse:
        ...
        try:
            ...
            return ConfigFileResponse(
                success=success,
                message=f"Configuration exported for camera '{request.camera}'" if success else f"Export failed for '{request.camera}'",
                data=result
            )
        except Exception as e:
    ...
    async def capture_image(self, request: CaptureImageRequest) -> CaptureResponse:
        ...
        try:
            ...
            return CaptureResponse(
                success=True,
                message=f"Image captured from camera '{request.camera}'",
                data=result
            )
        except Exception as e:
    ...
    async def capture_hdr_image(self, request: CaptureHDRRequest) -> HDRCaptureResponse:
        ...
        try:
            ...
            return HDRCaptureResponse(
                success=True,
                message=f"HDR image captured from camera '{request.camera}'",
                data=result
            )
        except Exception as e:
    ...
    async def get_bandwidth_settings(self) -> BandwidthSettingsResponse:
        ...
        try:
            ...
            return BandwidthSettingsResponse(
                success=True,
                message="Bandwidth settings retrieved successfully",
                data=settings
            )
        except Exception as e:
    ...
    async def set_bandwidth_limit(self, request: BandwidthLimitRequest) -> BoolResponse:
        ...
        try:
            ...
            return BoolResponse(
                success=True,
                message=f"Bandwidth limit set to {request.max_concurrent_captures}",
                data=True
            )
        except Exception as e:
    ...
    async def get_network_diagnostics(self) -> NetworkDiagnosticsResponse:
        ...
        try:
            ...
            return NetworkDiagnosticsResponse(
                success=True,
                message="Network diagnostics retrieved successfully",
                data=diagnostics
            )
        except Exception as e:
