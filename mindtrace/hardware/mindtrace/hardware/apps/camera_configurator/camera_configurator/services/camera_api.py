...
class CameraAPI:
    ...
    async def capture_image(self, camera_name: str, save_path: Optional[str] = None, 
                           upload_to_gcs: bool = False, output_format: str = "numpy") -> Dict[str, Any]:
    ...
    async def get_stream_url(self, camera_name: str, format: str = "mjpeg", quality: int = 85, fps: int = 30) -> Optional[str]:
