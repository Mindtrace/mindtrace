...
class AllenBradleyPLC(BasePLC):
    ...
    def __init__(
        ...
        self.logger.info(
            f"Allen Bradley PLC initialized: plc_type={self.plc_type}, "
            f"pycomm3_available={PYCOMM3_AVAILABLE}"
        )
            ...
            if self.driver_type == "LogixDriver":
                ...
                try:
                    ...
                    if device_info:
                        ...
                        elif ('POINT I/O' in product_name or 
                              'CompactBlock' in product_name or 
        ...
        return {
            ...
            "drivers": [
                ...
                },
                {
                    ...
                    "supported_models": ["SLC500", "MicroLogix 1000", "MicroLogix 1100", "MicroLogix 1400", "MicroLogix 1500"],
                    "capabilities": [
